...
<body>
	...
	<div class="inner-cont">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<span class="search-group">시작일 : <input type="text" id="startDt" name="startDt" title="날짜선택" class="hasDatepicker" value="${item.startDt }"  readonly="readonly" disabled="disabled"></span>
								<span class="search-p"> ~ </span>
								<span class="search-group">종료일 : <input type="text" id="endDt" name="endDt" title="날짜선택" class="hasDatepicker" value="${item.endDt }"  readonly="readonly" disabled="disabled"></span>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<div class="input-file">
									<label class="btn-gray">
										파일첨부
										<input type="file" id="contImgFile" name="contImgFile" onchange="setFilename('imageFile',this);" readonly="readonly" disabled="disabled">
									</label>
									<input type="text" readonly="readonly" title="이미지" id="imageFile" readonly="readonly" disabled="disabled">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="editor-area">
									<textarea id="cont" name="cont" title="내용" disabled="disabled">${item.cont}</textarea>
		...
		<div class="btn-area ar">
			...
			<a href="<c:url value="/AM/CO/CO04"/>?seqNo=${item.seqNo}" class="btn-black2">수정</a>
		</div>
