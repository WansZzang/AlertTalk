				...
				if ( confirm("삭제하시겠습니까?")){
					$.ajax({ 
						...
						success:function(data){
							alert('삭제되었습니다.');
							location.href = '<c:url value="/AM/BO/BO01"/>';
						}
					});
				}
			});
...
<body>
	...
	<p class="location">
		...
		<a href="#none" >Bottom</a> &gt;
		<strong>Bottom 상세</strong>
	</p>
	...
	<div class="inner-cont">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<ul class="radio-group">
									<li>
										<input type="radio" name="optShowYN" value="Y" <c:if test="${item.showYn eq 'Y'}">checked='checked'</c:if> readonly="readonly">
										<label for="at1">노출</label>
									</li>
									<li>
										<input type="radio" name="optShowYN" value="N" value="Y" <c:if test="${item.showYn eq 'N'}">checked='checked'</c:if> readonly="readonly">
							...
							<td>
								...
								<div class="input-file">
									<label class="btn-gray">
										파일첨부
										<input type="file" id="contImgFile" name="contImgFile" onchange="setFilename('imageFile',this);" readonly="readonly">
									</label>
						...
						<tr>
							...
							<td>
								...
								<input type="text" title="URL" name="url" placeholder="배너를 클릭 시 이동할 URL을 입력해 주세요." value="${item.adUrl}" readonly="readonly">
							</td>
						</tr>
					</tbody>
				</table>
		...
		<div class="btn-area ar">
			<a href="<c:url value="/AM/BO/BO01"/>" class="btn-black2">목록</a>
			<button type="button" class="btn-black2 btnDel"><span>삭제</span></button>
			<a href="<c:url value="/AM/BO/BO04"/>?seqNo=${item.seqNo}" class="btn-black2">수정</a>
		</div>
