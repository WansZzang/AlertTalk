						...
						<tr>
							...
							<td>
								<ul class="radio-group">
									...
									<li>
										<input type="radio" name="optShowYN" value="N" value="Y" <c:if test="${item.showYn eq 'N'}">checked='checked'</c:if>>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="password" title="게임광고주 PW" name="adPw" placeholder="PW를 입력해 주세요." value="${item.adId }">
							</td>
						</tr>
					</tbody> 
				</table>
