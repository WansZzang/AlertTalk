	...
	<script>
		$(function(){
			...
			$("#searchBtn").bind("click", function(){
				...
				if(listType == 1){
					$("#searchForm").attr('action', '<c:url value="/GM/GM01" />').submit();	
				}else if(listType == 2){
					$("#searchForm").attr('action', '<c:url value="/GM/GM11" />').submit();	
				}else if(listType == 3){
					$("#searchForm").attr('action', '<c:url value="/GM/GM21" />').submit();	
				}else{
					$("#searchForm").attr('action', '<c:url value="/GM/GM31" />').submit();
				}
			...
			$("#excelBtn").bind("click", function(){
				var listType = $('input[name=listType]').val();
				if(listType == 1){
					$("#searchForm").attr('action', '<c:url value="/GM/GM06?viewType=01&listType=1" />').submit();	
				}else if(listType == 2){
					$("#searchForm").attr('action', '<c:url value="/GM/GM06?viewType=01&listType=2" />').submit();	
				}else if(listType == 3){
					$("#searchForm").attr('action', '<c:url value="/GM/GM06?viewType=01&listType=3" />').submit();	
				}else{
					$("#searchForm").attr('action', '<c:url value="/GM/GM06?viewType=01&listType=4" />').submit();
				}
